...
class CoffeeList extends StatefulWidget {
  ...
  const CoffeeList({super.key, required this.coffee});
...
class _CoffeeListState extends State<CoffeeList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            "Coffees", // Add a title for a real AppBar look
            ...
            Expanded(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final p = widget.coffee[index];
                  bool isFavorite = favoriteCoffee.contains(index);
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => OnclickCoffee(coffee: p),
                                ),
                              );
                            },
                            child: Container(
                          ...
                          child: Container(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  if (isFavorite) {
                                    favoriteCoffee.remove(index);
                                  } else {
                                    favoriteCoffee.add(index);
                                  }
                                });
