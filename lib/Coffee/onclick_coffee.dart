...
import 'package:tourism/model/coffee.dart';

class OnclickCoffee extends StatefulWidget {
  final Coffee coffee;
  const OnclickCoffee({super.key, required this.coffee});

  @override
  State<OnclickCoffee> createState() => _OnclickCoffeeState();
}

class _OnclickCoffeeState extends State<OnclickCoffee> {
  @override
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.of(context).pushNamed('/CoffeList');
            },
          ),
        ),
